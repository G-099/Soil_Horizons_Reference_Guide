...
% This code is in the public domain. No rights reserved. Creative Commons 1.0 Universal. To view a copy of this disclaimer, visit https://creativecommons.org/publicdomain/zero/1.0/

\documentclass[12pt]{exam}
\newcommand{\semanticversion}{v1.5.1}               % Release version
\newcommand{\studentone}{Gage Linville}			    % Enter your name
\title{Soil Horizons Reference Guide}			    % Title of the project
\newcommand{\creationdate}{April 5th, 2023}         % Creation date
\newcommand{\revisiondate}{May 19th, 2025}        % Revision date
\newcommand{\license}{}
